...
function renderFollowers(ele){
    ...
    return `<div class="three wide column"><div class="ui card"><a href="https://list-in.herokuapp.com/profilePage/profile.html" class="ui bordered medium image followerImage">
